...
with open('mj.txt', "r") as file:
    for line in file:
        query = line.strip() + " Michael Jackson"  # Add artist name for a more specific search
...
for link in links:
    try:
        ...
        mp4_file_path = ys.download(output_path='MJ', filename=f"{yt.title}.mp4")
